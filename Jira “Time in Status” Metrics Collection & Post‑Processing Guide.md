...
### Graphs and how to read them (what to look for)

1. **Mean days per status × project (grouped bars)**

![](https://slabstatic.com/prod/assets/6lql0jy7/post/jy6hf173/preimages/9CTzTlHfrCVhqcZzqXeqGy3C.png?jwt=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJodHRwczovL3NsYWJzdGF0aWMuY29tIiwiZXhwIjoxNzYzOTE3NDIzLCJpYXQiOjE3NjI3MDc4MjMsImlzcyI6Imh0dHBzOi8vYXBwLnNsYWIuY29tIiwianRpIjoiMzFyNmFyOGFxYmcybTJyNTdnYnA3M3EyIiwibmJmIjoxNzYyNzA3ODIzLCJwYXRoIjoicHJvZC9hc3NldHMvNmxxbDBqeTcvcG9zdC9qeTZoZjE3MyJ9.X2Ev2VE53JCfB4kLUV4M-pJkhZhR2VRjKYxFz4EELIpMRUxxKwJzCRusowt31hSbxU8k2XkHuw2N_O1DdDW_NSQ8fbIsviSDtjRWCetIkg26J3m2QUCiF2Qy2UimlbB9aREwn_cpScdUza3l-BGgC2R_3oZpa6S3Rqr9YjjqCLR--fWRT-twSdViZk3KEJzuUm2n6OyAQ4HokGR-dbYNy2jFgI-zYkMgp7_gLN8CgXFuxICtmvWznzf-D31eo-14YeFCR9JTyDMavnGeytNVmRReCf-2_rk2D5Zu5qkpWO3X5hwisD_u9MuwR0gFhNA4v7eGbZIHnccLpam0NByPWg)

    - **What it shows:** For each mapped status (Not Started → Done), the _average_ number of days tickets spent there, with a separate bar per project.
    - **Use it for:** Spotting projects whose work lingers in a particular stage. Taller bars = more time in that stage.
    - **Gotchas:** A high mean can be skewed by a few outliers; corroborate with the percentile charts.
1. **Board-wide percentile lines (p50, p75, p85, p90, p95)**

![](https://slabstatic.com/prod/assets/6lql0jy7/post/jy6hf173/preimages/OYKDoArEQe1qL9lgmSBYdv9h.png?jwt=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJodHRwczovL3NsYWJzdGF0aWMuY29tIiwiZXhwIjoxNzYzOTE3NDIzLCJpYXQiOjE3NjI3MDc4MjMsImlzcyI6Imh0dHBzOi8vYXBwLnNsYWIuY29tIiwianRpIjoiMzFyNmFyOGFxYmcybTJyNTdnYnA3M3EyIiwibmJmIjoxNzYyNzA3ODIzLCJwYXRoIjoicHJvZC9hc3NldHMvNmxxbDBqeTcvcG9zdC9qeTZoZjE3MyJ9.X2Ev2VE53JCfB4kLUV4M-pJkhZhR2VRjKYxFz4EELIpMRUxxKwJzCRusowt31hSbxU8k2XkHuw2N_O1DdDW_NSQ8fbIsviSDtjRWCetIkg26J3m2QUCiF2Qy2UimlbB9aREwn_cpScdUza3l-BGgC2R_3oZpa6S3Rqr9YjjqCLR--fWRT-twSdViZk3KEJzuUm2n6OyAQ4HokGR-dbYNy2jFgI-zYkMgp7_gLN8CgXFuxICtmvWznzf-D31eo-14YeFCR9JTyDMavnGeytNVmRReCf-2_rk2D5Zu5qkpWO3X5hwisD_u9MuwR0gFhNA4v7eGbZIHnccLpam0NByPWg)

    - **What it shows:** For the entire board (all projects together), how long tickets take per status at different cutoffs.
        - **p50** = median (typical case)
        - **p75/p85/p90/p95** = progressively “slower” cases (tail risk)
    - **Use it for:** SLAs and expectations. e.g., “90% of tickets finish Peer Review within ~X days.”
    - **Read it:** If higher-percentile lines rise sharply for a status, that stage has a heavy tail (some tickets take **much** longer).
1. **Per-project percentile lines (one chart per project)**

![](https://slabstatic.com/prod/assets/6lql0jy7/post/jy6hf173/preimages/Eo4Sdzmee7G2e80h2EMm9f1R.png?jwt=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOi
![](https://slabstatic.com/prod/assets/6lql0jy7/post/jy6hf173/preimages/RI0Z43dKQp5r9Mj4Ww4QftCc.png?jwt=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJodHRwczovL3NsYWJzdGF0aWMuY29tIiwiZXhwIjoxNzYzOTE3NDIzLCJpYXQiOjE3NjI3MDc4MjMsImlzcyI6Imh0dHBzOi8vYXBwLnNsYWIuY29tIiwianRpIjoiMzFyNmFyOGFxYmcybTJyNTdnYnA3M3EyIiwibmJmIjoxNzYyNzA3ODIzLCJwYXRoIjoicHJvZC9hc3NldHMvNmxxbDBqeTcvcG9zdC9qeTZoZjE3MyJ9.X2Ev2VE53JCfB4kLUV4M-pJkhZhR2VRjKYxFz4EELIpMRUxxKwJzCRusowt31hSbxU8k2XkHuw2N_O1DdDW_NSQ8fbIsviSDtjRWCetIkg26J3m2QUCiF2Qy2UimlbB9aREwn_cpScdUza3l-BGgC2R_3oZpa6S3Rqr9YjjqCLR--fWRT-twSdViZk3KEJzuUm2n6OyAQ4HokGR-dbYNy2jFgI-zYkMgp7_gLN8CgXFuxICtmvWznzf-D31eo-14YeFCR9JTyDMavnGeytNVmRReCf-2_rk2D5Zu5qkpWO3X5hwisD_u9MuwR0gFhNA4v7eGbZIHnccLpam0NByPWg)

    - **What it shows:** Same idea as #2, but broken out per project.
    - **Use it for:** Comparing different projects’ consistency and tail risk stage-by-stage.
    - **Read it:**
        - Flat, tightly clustered lines → consistent cycle times.
        - Big gaps between p50 and p90 → variability/occasional long blockers.
1. **Heatmap: mean days by project × status**

![](https://slabstatic.com/prod/assets/6lql0jy7/post/jy6hf173/preimages/q119404RpJeqSbzhpvuI5GBo.png?jwt=eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJodHRwczovL3NsYWJzdGF0aWMuY29tIiwiZXhwIjoxNzYzOTE3NDIzLCJpYXQiOjE3NjI3MDc4MjMsImlzcyI6Imh0dHBzOi8vYXBwLnNsYWIuY29tIiwianRpIjoiMzFyNmFyOGFxYmcybTJyNTdnYnA3M3EyIiwibmJmIjoxNzYyNzA3ODIzLCJwYXRoIjoicHJvZC9hc3NldHMvNmxxbDBqeTcvcG9zdC9qeTZoZjE3MyJ9.X2Ev2VE53JCfB4kLUV4M-pJkhZhR2VRjKYxFz4EELIpMRUxxKwJzCRusowt31hSbxU8k2XkHuw2N_O1DdDW_NSQ8fbIsviSDtjRWCetIkg26J3m2QUCiF2Qy2UimlbB9aREwn_cpScdUza3l-BGgC2R_3oZpa6S3Rqr9YjjqCLR--fWRT-twSdViZk3KEJzuUm2n6OyAQ4HokGR-dbYNy2jFgI-zYkMgp7_gLN8CgXFuxICtmvWznzf-D31eo-14YeFCR9JTyDMavnGeytNVmRReCf-2_rk2D5Zu5qkpWO3X5hwisD_u9MuwR0gFhNA4v7eGbZIHnccLpam0NByPWg)

    - **What it shows:** A matrix where darker cells mean more average days.
    - **Use it for:** Quick scanning to find which stages are the slowest per project.
    - **Read it:** Focus on the darkest cells—those project×status pairs are your best candidates for workflow improvements.

---

**Questions?** Ping the doc owner in Slack.
